...
class PaypalController extends Controller
{
    ...
    public function expressCheckout(Request $request)
    {
        ...
        if (!$response['paypal_link']) {
            return redirect('/paywithpaypal')->with(['code' => 'danger', 'message' => 'Something went wrong with PayPal']);
    ...
    public function expressCheckoutSuccess(Request $request)
    {
        ...
        if (!in_array(strtoupper($response['ACK']), ['SUCCESS', 'SUCCESSWITHWARNING'])) {
            return redirect('/paywithpaypal')->with(['code' => 'danger', 'message' => 'Error processing PayPal payment']);
        }
        ...
        if ($invoice->paid) {
            return redirect('/paywithpaypal')->with(['code' => 'success', 'message' => 'Order ' . $invoice->id . ' has been paid successfully!']);
        }

        return redirect('/paywithpaypal')->with(['code' => 'danger', 'message' => 'Error processing PayPal payment for Order ' . $invoice->id . '!']);
    }
